...
export function ClientsView() {
  ...
  const [isLoadingCampaignLeads, setIsLoadingCampaignLeads] = useState(true);
  ...
  useEffect(() => {
    const audio = new Audio('data:audio/mp3;base64,...');
    audio.preload = 'auto';
  ...
  const handleClaimCampaignLead = (lead: CampaignLead) => {
        ...
        startClaimingTransition(async () => {
            const scriptText = campaign.script ? campaign.script.replace(/<cliente>/g, lead.name) : '';
            const originalDataText = Object.entries(lead.originalData)
                .map(([key, value]) => `${key}: ${value}`)
                .join('\n');
            
            const remarketingText = `${scriptText}\n\n--- Dados do Lead ---\n${originalDataText}`.trim();
                                ...
                                <TableBody>
                                    {pendingReminders.map((reminder) => (
                                        <TableRow key={reminder.id} className={cn(isPast(parseISO(reminder.reminderDate)) && 'bg-destructive/10')}>
                                            ...
                                            <TableCell className="text-right">
                                                <Button size="sm" onClick={() => handleToggleReminder(reminder.id, true)}>
